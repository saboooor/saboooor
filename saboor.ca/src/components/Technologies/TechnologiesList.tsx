...
const QwikLogo = component$(() => (
  <img src={QwikIcon} alt="Qwik Logo" width={56} height={56} />
));
const PythonLogo = component$(() => (
  <img src={PythonIcon} alt="Python Logo" width={56} height={56} />
));
const TauriLogo = component$(() => (
  <img src={TauriIcon} alt="Tauri Logo" width={56} height={56} />
));
const JavaLogo = component$(() => (
  <img src={JavaIcon} alt="Java Logo" width={56} height={56} />
));
...
export const Technologies: Project[] = [
  {
    ...
    image: <SiTypescript size={56} class="min-w-14 fill-blue-500" />,
  ...
  },
  {
    ...
    image: <SiTailwindcss size={56} class="min-w-14 fill-cyan-500" />,
  ...
  },
  {
    ...
    image: <SiNodedotjs size={56} class="min-w-14 fill-green-500" />,
  ...
  },
  {
    ...
    image: <SiReact size={56} class="min-w-14 fill-blue-500" />,
    imageClass: 'fill-blue-500 min-w-14',
    class: 'lum-grad-bg-blue-950/20 hover:lum-bg-blue-950',
  },
  {
  ...
  },
  {
    ...
    image: <SiRust size={56} class="min-w-14 fill-orange-500" />,
